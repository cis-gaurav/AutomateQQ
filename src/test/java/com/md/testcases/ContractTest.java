...
//	/*
//	@Test(priority=32)
//	public void VerifyUserIsAbleToAddPublicNote() throws InterruptedException{		
//		logger = extent.createTest(Thread.currentThread().getStackTrace()[1].getMethodName().toString());
//		boolean flag = contractPage.VerifyUserIsAbleToAddPublicNote();
//		Assert.assertTrue(flag);
//	}
//	
//	@Test(priority=33)
//	public void VerifyUserIsAbleToAddPrivateNote() throws InterruptedException{		
//		logger = extent.createTest(Thread.currentThread().getStackTrace()[1].getMethodName().toString());
//		boolean flag = contractPage.VerifyUserIsAbleToAddPrivateNote();
//		Assert.assertTrue(flag);
//	}*/
//	
//	@Test(priority=34)
